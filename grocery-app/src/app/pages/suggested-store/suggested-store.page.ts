...
@Component({
  ...
  templateUrl: './suggested-store.page.html',
  styleUrls: ['./suggested-store.page.scss'],
})
export class SuggestedStorePage implements OnInit {
  AccountID: any;
  dataitem:any;
  ...
  loaddata(id:number){
    ...
    let url="http://localhost/gs-app/backend/suggest.php";
